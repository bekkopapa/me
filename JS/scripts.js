      ...
      loadTable('tables/novelist_table.html', function(responseText) {
        ...
        tableContainer.html('');
            ...
            const quotes = [
                ...
                { text: '호모 사피엔스, 간헐적 혁명으로 그럴듯한 역사를 써왔을 뿐, 여전히 인간은 그저 인간일 뿐이다. 인간은 극복되지 못했다.', author: '-진 오시리스 / 프린테라'},
                { text: '두 팔을 축 늘어뜨리고 맨발로 섰는데, 머리칼이 새하얀 백발이다. 얼굴은 그보다 더 하얗다. 초상이라도 치른 듯 여자는 까만 소복 차림이다. 팔은 기형적으로 길어 소매 밖으로 한참 비어져 나와 하얀 손이 거의 무릎에 닿아 있다. 손가락 끝의 손톱은 송곳처럼 뾰족하다. 까만 치마 아래로 제 얼굴처럼 하얀 두 발, 발톱도 손톱만큼 날카롭고 길다.', author: '아비'},
                { text: '죽고 싶었다. 그렇지만 그럴만한 용기가 없었다. 난 어릴 적부터 겁이 많았다. 아니 겁이 많기보다는 아픔이, 고통이 두려웠다...... 난 아무것도 할 수 없고 아무것도 하고 싶지 않은 인간이었다.', author: '-화마 / 히키코모리 카페' },
              ];
